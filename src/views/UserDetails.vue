<template>
    <div class="row">
        <h2 class="col-sm-10 align-middle">Update User Detail</h2>
        <div class="col-sm-2">
        ...
        <div class="toast align-items-center text-white border-0 w-100 show" :class="theme" role="alert" aria-live="polite" aria-atomic="true" v-if="update || errors.length">
            <div class="d-flex">
                <div class="toast-body">
                    <span v-if="update">User details updated successfully.</span>
        ...
        <form @submit.prevent="updateUser">
            <div class="mb-3 mt-3 row">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" id="inputEmail" v-model="users.first_name">
                </div>
            </div>
            <div class="mb-3 mt-3 row">
                <label for="inputEmail" class="col-sm-2 col-form-label">Last Name</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" id="inputEmail" v-model="users.last_name">
                </div>
            </div>
            <div class="mb-3 mt-3 row">
            ...
            <div class="mb-3 mt-3 row">
                ...
                <div class="col-sm-10">
                <input type="text" class="form-control" id="inputEmail" v-model="users.phone">
                </div>
            </div>
            <div class="mb-3 row">
                <div class="col-sm-5">
    ...
    export default {
        ...
        methods: {
            getUser() {
                ...
                axios.get('http://127.0.0.1:3000/v1/api/getUser/'+this.$route.params.id, {headers: headers})
                .then(result => {
            ...
            updateUser() {
                ...
                if (!this.errors.length) {
                    axios.post('http://127.0.0.1:3000/v1/api/updateUser/'+this.$route.params.id, data, {headers: headers})
                    .then(response => {  
